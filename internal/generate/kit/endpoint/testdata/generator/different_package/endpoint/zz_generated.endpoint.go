...
import (
	...
	"sagikazarmark.dev/mga/internal/generate/kit/endpoint/testdata/generator/different_package"
	svctype "sagikazarmark.dev/mga/internal/generate/kit/endpoint/testdata/generator/different_package/svctype"
)
...
func MakeEndpoints(service different_package.Service, middleware ...endpoint.Middleware) Endpoints {
	mw := kitxendpoint.Combine(middleware...)

	return Endpoints{CreateTodo: kitxendpoint.OperationNameMiddleware("different_package.CreateTodo")(mw(MakeCreateTodoEndpoint(service)))}
}
...
func TraceEndpoints(endpoints Endpoints) Endpoints {
	return Endpoints{CreateTodo: kitoc.TraceEndpoint("different_package.CreateTodo")(endpoints.CreateTodo)}
}
...
func MakeCreateTodoEndpoint(service different_package.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(CreateTodoRequest)

		todo, err := service.CreateTodo(ctx, req.Text)
